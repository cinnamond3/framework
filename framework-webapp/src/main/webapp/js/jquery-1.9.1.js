...
(function(window, undefined) {
    ...
    jQuery.extend({
        ...
        type : function(obj) {
            ...
            return typeof obj === "object" || typeof obj === "function" ? class2type[core_toString.call(obj)]
                    || "object" : typeof obj;
        },
    ...
    /*
     * Create a callback list using the following parameters: options: an optional list of space-separated options that will
     * change how the callback list behaves or a more traditional option object By default a callback list will act like an
     * event callback list and can be "fired" multiple times. Possible options: once: will ensure the callback list can only
     * be fired once (like a Deferred) memory: will keep track of previous values and will call any callback added after the
     * list has been fired right away with the latest "memorized" values (like a Deferred) unique: will ensure a callback
     * can only be added once (no duplicate in the list) stopOnFalse: interrupt callings when a callback returns false
     */
    ...
    jQuery.support = (function() {
        ...
        var support, all, a, input, select, fragment, opt, eventName, isSupported, i, div = document
                .createElement("div");
    ...
    if (!getSetAttribute) {
        ...
        nodeHook = jQuery.valHooks.button = {
            get : function(elem, name) {
                var ret = elem.getAttributeNode(name);
                return ret
                        && (name === "id" || name === "name" || name === "coords" ? ret.value !== "" : ret.specified) ? ret.value
                        : undefined;
            },
            set : function(elem, value, name) {
    ...
    /*
     * Helper functions for managing events -- not part of the public interface. Props to Dean Edwards' addEvent library for
     * many of the ideas.
     */
    jQuery.event = {
        ...
        add : function(elem, types, handler, data, selector) {
            ...
            if (!(eventHandle = elemData.handle)) {
                eventHandle = elemData.handle = function(e) {
                    ...
                    return typeof jQuery !== core_strundefined && (!e || jQuery.event.triggered !== e.type) ? jQuery.event.dispatch
        ...
        trigger : function(event, data, elem, onlyHandlers) {
            var handle, ontype, cur, bubbleType, special, tmp, i, eventPath = [ elem || document ], type = core_hasOwn
                    .call(event, "type") ? event.type : event, namespaces = core_hasOwn.call(event, "namespace") ? event.namespace
                    .split(".")
                    : [];
        ...
        dispatch : function(event) {
            ...
            var i, ret, handleObj, matched, j, handlerQueue = [], args = core_slice.call(arguments), handlers = (jQuery
                    ...
                    if (cur.nodeType === 1 && (cur.disabled !== true || event.type !== "click")) {
                        ...
                        for (i = 0; i < delegateCount; i++) {
                            ...
                            if (matches[sel] === undefined) {
                                matches[sel] = handleObj.needsContext ? jQuery(sel, this).index(cur) >= 0 : jQuery
    ...
    jQuery.Event = function(src, props) {
        ...
        if (src && src.type) {
            ...
            this.isDefaultPrevented = (src.defaultPrevented || src.returnValue === false || (src.getPreventDefault && src
    ...
    /*
     * ! Sizzle CSS Selector Engine Copyright 2012 jQuery Foundation and other contributors Released under the MIT license
     * http://sizzlejs.com/
     */
    (function(window, undefined) {
        ...
        rcomma = new RegExp("^" + whitespace + "*," + whitespace + "*"), rcombinators = new RegExp("^" + whitespace
                + "*([\\x20\\t\\r\\n\\f>+~])" + whitespace + "*"), rpseudo = new RegExp(pseudos), ridentifier = new RegExp(
                "^" + identifier + "$"),
         ...
         * 
         * @returns {Function(string, Object)} Returns the Object data after storing it on itself with property name the
         *          (space-suffixed) string and (if the cache is larger than Expr.cacheLength) deleting the oldest entry
         */
            ...
            if (support.getIdNotName) {
                ...
                Expr.find["ID"] = function(id, context) {
                    if (typeof context.getElementById !== strundefined && !documentIsXML) {
                        ...
                        return m ? m.id === id
                                || (typeof m.getAttributeNode !== strundefined && m.getAttributeNode("id").value === id) ? [ m ]
                                : undefined
                                : [];
                    }
                };
        ...
        Sizzle.matchesSelector = function(elem, expr) {
            ...
            if (support.matchesSelector && !documentIsXML && (!rbuggyMatches || !rbuggyMatches.test(expr))
                    && !rbuggyQSA.test(expr)) {
                try {
        ...
        Sizzle.attr = function(elem, name) {
            ...
            return ((val = elem.getAttributeNode(name)) || elem.getAttribute(name)) && elem[name] === true ? name : val
        ...
        Expr = Sizzle.selectors = {
            ...
            preFilter : {
                ...
                "CHILD" : function(match) {
                    /*
                     * matches from matchExpr["CHILD"] 1 type (only|nth|...) 2 what (child|of-type) 3 argument
                     * (even|odd|\d*|\d*n([+-]\d+)?|...) 4 xn-component of xn+y argument ([+-]?\d*n|) 5 sign of xn-component 6 x
                     * of xn-component 7 sign of y-component 8 y of y-component
                     */
            ...
            filter : {
                ...
                "CLASS" : function(className) {
                    ...
                    return pattern
                            || ((pattern = new RegExp("(^|" + whitespace + ")" + className + "(" + whitespace + "|$)")) && classCache(
                            ...
                            function(elem, context, xml) {
                                ...
                                if (parent) {
                                    ...
                                    if (forward && useCache) {
                                        ...
                                        while ((node = (++nodeIndex && node && node[dir]) || (diff = nodeIndex = 0)
                                                || start.pop())) {
            ...
            pseudos : {
                ...
                "lang" : markFunction(function(lang) {
                    ...
                    return function(elem) {
                        var elemLang;
                        do {
                            if ((elemLang = documentIsXML ? elem.getAttribute("xml:lang") || elem.getAttribute("lang")
                                    : elem.lang)) {
                ...
                if ((matcher = Expr.relative[tokens[i].type])) {
                    ...
                    if (matcher[expando]) {
                        ...
                        return setMatcher((i > 1) && elementMatcher(matchers), (i > 1)
                                && toSelector(tokens.slice(0, i - 1)).replace(rtrim, "$1"), matcher, (i < j)
        ...
        function select(selector, context, results, seed) {
            ...
            if (!seed) {
                ...
                if (match.length === 1) {
                    ...
                    if ((tokens.length > 2) && (token = tokens[0]).type === "ID" && context.nodeType === 9
                            && !documentIsXML && Expr.relative[tokens[1].type]) {
                    ...
                    while (i--) {
                        ...
                        if ((find = Expr.find[type])) {
                            ...
                            if ((seed = find(token.matches[0].replace(runescape, funescape), (rsibling
                                    .test(tokens[0].type) && context.parentNode)
                                    || context))) {
    ...
    jQuery.fn
            .extend({
                ...
                domManip : function(args, table, callback) {
                    ...
                    if (isFunction
                            || !((l <= 1) || typeof value !== "string" || jQuery.support.checkClone || !rchecked
                                    .test(value))) {
                    ...
                    if (l) {
                        ...
                        if (first) {
                            ...
                            for (; i < l; i++) {
                                ...
                                callback.call(table && jQuery.nodeName(this[i], "table") ? findOrAppend(this[i],
                                        "tbody") : this[i], node, i);
                            }
    ...
    function getAll(context, tag) {
        var elems, elem, i = 0, found = typeof context.getElementsByTagName !== core_strundefined ? context
                .getElementsByTagName(tag || "*") : typeof context.querySelectorAll !== core_strundefined ? context
    ...
    function getWidthOrHeight(elem, name, extra) {
        ...
        var valueIsBorderBox = true, val = name === "width" ? elem.offsetWidth : elem.offsetHeight, styles = getStyles(elem), isBorderBox = jQuery.support.boxSizing
        ...
        jQuery.cssHooks[name] = {
            get : function(elem, computed, extra) {
                if (computed) {
                    ...
                    return elem.offsetWidth === 0 && rdisplayswap.test(jQuery.css(elem, "display")) ? jQuery.swap(elem,
                            cssShow, function() {
    ...
    if (jQuery.expr && jQuery.expr.filters) {
        jQuery.expr.filters.hidden = function(elem) {
            ...
            return ((elem.offsetWidth <= 0) && (elem.offsetHeight <= 0))
                    || (!jQuery.support.reliableHiddenOffsets && ((elem.style && elem.style.display) || jQuery.css(
                            elem, "display")) === "none");
        };
    ...
    /*
     * Prefilters 1) They are useful to introduce custom dataTypes (see ajax/jsonp.js for an example) 2) These are
     * called: - BEFORE asking for a transport - AFTER param serialization (s.data is a string if s.processData is true)
     * 3) key is the dataType 4) the catchall symbol "*" can be used 5) execution will start with transport dataType and
     * THEN continue down to "*" if needed
     */
    prefilters = {},

    /*
     * Transports bindings 1) key is the dataType 2) the catchall symbol "*" can be used 3) selection will start with
     * transport dataType and THEN go to "*" if needed
     */
    transports = {},
    ...
    jQuery
            .extend({
                ...
                ajax : function(url, options) {
                    ...
                    globalEventContext = s.context && (callbackContext.nodeType || callbackContext.jquery) ? jQuery(callbackContext)
                            : jQuery.event,
                    // Deferreds
    ...
    /*
     * Handles responses to an ajax request: - sets all responseXXX fields accordingly - finds the right dataType (mediates
     * between content-type and expected dataType) - returns the corresponding response
     */
    ...
    /*
     * Microsoft failed to properly implement the XMLHttpRequest in IE7 (can't request local files), so we use the
     * ActiveXObject when it is available Additionally XMLHttpRequest can be disabled in IE7/IE8 so we need a fallback.
     */
    function() {
    ...
    function Animation(elem, properties, options) {
        var result, stopped, index = 0, length = animationPrefilters.length, deferred = jQuery.Deferred().always(
                function() {
    ...
    function defaultPrefilter(elem, props, opts) {
        ...
        var prop, index, length, value, dataShow, toggle, tween, hooks, oldfire, anim = this, style = elem.style, orig = {}, handled = [], hidden = elem.nodeType
                && isHidden(elem);
    ...
    jQuery.each([ "toggle", "show", "hide" ], function(i, name) {
        ...
        jQuery.fn[name] = function(speed, easing, callback) {
            return (speed == null) || typeof speed === "boolean" ? cssFn.apply(this, arguments) : this.animate(genFx(
                    name, true), speed, easing, callback);
        };
    });
                ...
                finish : function(type) {
                    ...
                    return this.each(function() {
                        var index, data = jQuery._data(this), queue = data[type + "queue"], hooks = data[type
                                + "queueHooks"], timers = jQuery.timers, length = queue ? queue.length : 0;
            ...
            jQuery.fn[funcName] = function(margin, value) {
                ...
                return jQuery.access(this, function(elem, type, value) {
                    ...
                    if (elem.nodeType === 9) {
                        ...
                        // Either scroll[Width/Height] or offset[Width/Height] or client[Width/Height], whichever is
                        // greatest
                        // unfortunately, this causes bug #3838 in IE6/8 only, but there is currently no good, small way to
                        // fix it.
